...
#### ⑤ Apple 纯白极简移动中枢 (无线遥控翻页 · 无线实物展台)
1. 在功能区点击 **`开启控制`** 并使用手机扫描 **`遥控二维码`**。
2. 手机端将直接进入 Apple 现代纯白极简 Web 界面（扁平轻质感、触感震动反馈）：
   - 🎮 **智能遥控翻页**：极简扁平按键布局，超大 Apple 蓝【下一页】触控，配合【上一页】与【视频播放/暂停】，触控伴随 iOS 级震动。
   - 📷 **无线实物展台 (免安装 App，扫码即用)**：
     - **📸 一键拍照投屏**：走下讲台拍摄学生作业，1 秒内高清照片自动全屏铺满 PPT 页面，大屏自动唤出画笔进行圈画批注打分！
     - **🔄 大屏 90° 旋转**：支持大屏顺时针旋转，横竖版作业完美适应。
     - **🎥 实时动态展台**：手机摄像头实时直播推流到 PPT 画面，适合理化生实验演示。
     - **💡 补光灯**：弱光环境下开启手机闪光灯补光。
     - **⏹️ 一键退出**：随时点击退出展台，PPT 瞬间恢复原幻灯片播放。
